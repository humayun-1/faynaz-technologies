...
let mouse_wrapper = document.createElement("div");
mouse_wrapper.innerHTML = `<div id="cursor">
<div class="cursor__circle"></div>
</div>`;

document.querySelector("body").appendChild(mouse_wrapper);
...
{
  /* <circle class="progress-circle " cx="25" cy="25" r="22" style="stroke-dasharray: 137.4; stroke-dashoffset: 26.5182;"></circle> */
}

let scroll_progress_wrapper = document.createElement("div");
scroll_progress_wrapper.innerHTML = `<span></span><svg viewBox="0 0 50 50" class="scroll-progress-circle">
<path d="M25 25 m0 -20 a20 20 0 1 0 0 40 a20 20 0 1 0 0 -40"/>
</svg>`;
scroll_progress_wrapper.classList.add("scroll_progress_wrapper");
document.querySelector("body").appendChild(scroll_progress_wrapper);
...
document.addEventListener("DOMContentLoaded", () => {
  setTimeout(() => {
    type_writter_w.remove();
  }, 1500);
});

let whatsappIn_W = document.createElement("div");
whatsappIn_W.innerHTML = `<a
class="set-url-target"
rel="noopener"
data-mobile-target=""
data-desktop-target="_blank"
target="_blank"
href="https://wa.me/923465314445"
><svg
  class="ico_d"
  width="64"
  height="64"
...
document.querySelector("body").appendChild(whatsappIn_W);

let scroll_progress_span = document.querySelector(
  ".scroll_progress_wrapper > span"
);

function scroll_progress_span_hide() {
  if (
    scroll_progress_span.innerText == "" ||
    scroll_progress_span.innerText == "0%"
  ) {
    scroll_progress_span.parentElement.style.cssText += "display:none;";
  } else if (scroll_progress_span.innerText == "100%") {
    scroll_progress_span.style.cssText += "color:#4dab4d;";
    document.querySelector(".scroll-progress-circle").style.cssText =
      "stroke:#4dab4d;";
  } else {
    scroll_progress_span.parentElement.style.cssText = "";
    scroll_progress_span.style.cssText = "";
    document.querySelector(".scroll-progress-circle").style.cssText = "";
  }
}
window.addEventListener("scroll", scroll_progress_span_hide);
scroll_progress_span_hide();
