...
(function () {
  ...
  var AR = {
    ...
    ht1: "مهندسون كبار فقط", ht2: "تملك الكود والملكية الفكرية", ht3: "البدء خلال أسبوعين",
    ...
    tst_eyebrow: "آراء العملاء", tst_h2: "فرقٌ ائتمنتنا على الإطلاق.", tst_p: "كلمات قليلة عن العمل مع فريق صغير من كبار المهندسين يتحمّل مسؤولية النتيجة.",
    tst1_q: "أعاد فريق فايناز بناء خط النشر لدينا وحوّل الإصدارات من يومٍ كامل متوتر إلى نشرٍ بضغطة واحدة. عملوا كمهندسينا لا كوكالة بعيدة.",
    tst1_n: "قائد هندسي", tst1_r: "منصة SaaS للأعمال",
    tst2_q: "أطلقوا نسختنا الأولى خلال ستة أسابيع وصمدت عند الإطلاق. التواصل المباشر مع من يكتب الكود جعل كل قرار أسرع.",
    tst2_n: "مؤسّس", tst2_r: "شركة ناشئة في مراحلها الأولى",
    tst3_q: "أزالت الأتمتة بالذكاء الاصطناعي ساعات من العمل اليدوي أسبوعياً. نطاق واضح، سعر ثابت، وبلا مفاجآت.",
    tst3_n: "مدير العمليات", tst3_r: "شركة خدمات"
  };
